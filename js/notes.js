    ...
    const data = {
        ...
        player: {
            ...
            items: [
                ...
                {
                    icon: icons.stop,
                    text: "Во время матча никто не должен играть вторым мячом находясь в неотделенной от игровой площадки части зала."
                },
                {
                    icon: icons.users,
        ...
        common: [
            ...
            {
                icon: icons.coffee,
                text: "В залы закуплена вода (условно по 1 л), батончики (по 2 батончика на каждого игрока на каждый день), чай, кофе, сахар, стаканчики (пожалуйста, подпишите бумажные стаканчики и пользуйтесь ими в течение дня для чая и кофе, а для воды есть одноразовые пластиковые). Так же будет стоять кулер либо термопот и бутыль с помпой. В «Метеоре» есть кафетерий, работает до 21:00. Важно: батончики рассчитаны только на игроков, остальное - и для зрителей, и для игроков."
            },
            {
                icon: icons.trash,
