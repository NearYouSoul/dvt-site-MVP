    ...
    function render() {
        ...
        promoBlock.innerHTML = `
            ...
            <div class="flex flex-col md:flex-row gap-4 justify-center">
                ...
                <a href="https://winner-9bee4.firebaseapp.com/?action=follow_tournament&id=KJf5ZdO3vHA2VWwEAJSm" target="_blank" 
                   class="inline-flex items-center justify-center px-6 py-3 bg-[#5A7ACD] hover:bg-blue-600 text-white rounded-xl font-bold shadow-md transition-all gap-2">
